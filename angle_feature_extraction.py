...
#Extract Angle Features for inference (can be utilized for training with minor changes)
class ExtractAngleFeatures: 
    ...
    def generate_features(self, raw_image): 
        ...
        with mp_hands.Hands(static_image_mode = True,max_num_hands = 2,
            ...
            processed = hands.process(cv2.flip(cv2.cvtColor(raw_image, cv2.COLOR_BGR2RGB), 1))
